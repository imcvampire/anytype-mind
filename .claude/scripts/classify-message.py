...
SIGNALS = [
    {
        "name": "DECISION",
        "message": "DECISION detected — consider creating a decision-type object in Anytype via MCP",
        "patterns": [
            # English
    ...
    {
        "name": "INCIDENT",
        "message": "INCIDENT detected — consider using /incident-capture or creating an incident-type object in Anytype via MCP",
        "patterns": [
            # English
    ...
    {
        "name": "1:1 CONTENT",
        "message": "1:1 CONTENT detected — consider creating a one_on_one-type object and updating the person object in Anytype via MCP",
        "patterns": [
            # English
    ...
    {
        "name": "WIN",
        "message": "WIN detected — consider creating a brag_entry-type object in Anytype with relations to evidence objects",
        "patterns": [
    ...
    {
        "name": "ARCHITECTURE",
        "message": "ARCHITECTURE discussion — consider creating a brain_note or decision object in Anytype via MCP",
        "patterns": [
            # English
    ...
    {
        "name": "PERSON CONTEXT",
        "message": "PERSON CONTEXT detected — consider updating the relevant person object in Anytype and creating relations from the conversation object",
        "patterns": [
            # English
    ...
    {
        "name": "PROJECT UPDATE",
        "message": "PROJECT UPDATE detected — consider updating the active work_note object in Anytype and checking if wins should become brag_entry objects",
        "patterns": [
            # English
        ...
        output = {
            "hookSpecificOutput": {
                ...
                "additionalContext": (
                    ...
                    + hints
                    + "\n\nRemember: use proper type_keys, set required properties, create relations. Follow SKILL.md conventions."
                )
            }
        }
